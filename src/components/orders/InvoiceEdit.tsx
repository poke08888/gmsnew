      ...
      <div style="border-bottom: 2px solid #4f46e5; padding-bottom: 20px; margin-bottom: 20px;">
        ...
        <div style="display: flex; justify-content: space-between;">
           <div style="width: 65%;">
             ...
             <p style="margin: 3px 0; color: #6b7280;">Mã đơn: #${order.orderCode || order._id}</p>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
            <div class="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
                <div class="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
                  <h3 class="font-bold text-gray-800 flex items-center gap-2">Hóa Đơn: {draft.value?.orderCode || orderAction.order?.orderCode || orderAction.order?._id}</h3>
